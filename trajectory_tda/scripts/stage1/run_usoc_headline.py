...
def main() -> None:
    ...
    cache_name = f"null_diagrams_usoc{frozen_tag}_B{args.B}_L{args.L}_seed{args.seed}{smoke_tag}_{today}.npz"
    ...
    out_path = out_dir / f"usoc_headline{frozen_tag}{smoke_tag}_{today}.json"
    payload = {
        "phase": phase_tag,
        "run_params": {
            "L": args.L,
