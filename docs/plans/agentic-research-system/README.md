...
| [proposals/large-workflow-context-budget-and-orchestration-protocol-2026-07-22.md](proposals/large-workflow-context-budget-and-orchestration-protocol-2026-07-22.md) | V1-assessed standalone protocol for context budgets, fresh delegation, stage-scoped skill loading, user-owned external review, and certify-before-regenerate behavior |
