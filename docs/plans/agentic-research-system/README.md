...
| [design/09-wp6-2-t2-cost-grant-authority-addendum-2026-07-22.md](design/09-wp6-2-t2-cost-grant-authority-addendum-2026-07-22.md) | P-037 proposed T2 CommandService authority, cost reservation/reconciliation, strict identity, and negative-control contract; pending fresh independent review and Stephen exact-hash acceptance, with no runtime authority |
