...
| [proposals/large-workflow-context-budget-and-orchestration-protocol-2026-07-22.md](proposals/large-workflow-context-budget-and-orchestration-protocol-2026-07-22.md) | V2-assessed standalone protocol recommended for advisory integration; strict enforcement remains deferred |
| [proposals/wp6-2-t2-cost-grant-authority-and-versioning-ruling-2026-07-22.md](proposals/wp6-2-t2-cost-grant-authority-and-versioning-ruling-2026-07-22.md) | Owner-decision packet for the missing T2 CommandService transition family and non-destructive schema versioning |
