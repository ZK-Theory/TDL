...
**Status:** W1–W5 and Gate 3 accepted under P-027–P-030; P-042/06g accepted for governing planning, with WP6.3 readiness assessment next; runtime remains gated<br>
**Created:** 2026-06-27  
...
| [proposals/large-workflow-context-budget-and-orchestration-protocol-2026-07-22.md](proposals/large-workflow-context-budget-and-orchestration-protocol-2026-07-22.md) | Historical advisory and trial rationale; superseded for dispatch by `tda-large-workflow-supervision` v1.2 |
| [proposals/wp6-2-t2-cost-grant-authority-and-versioning-ruling-2026-07-22.md](proposals/wp6-2-t2-cost-grant-authority-and-versioning-ruling-2026-07-22.md) | P-037 accepted contract-stage ruling; provider-transport atomicity and dispatch semantics remain unresolved and no runtime authority is granted |
...
| [proposals/wp6-2-t2-research-first-scope-and-r3-remediation-ruling-2026-07-22.md](proposals/wp6-2-t2-research-first-scope-and-r3-remediation-ruling-2026-07-22.md) | Accepted P-039 research-value and T2 scope ruling; immutable R3 binding and acceptance are supplied by P-040 and the external owner-acceptance record |
| [reviews/large-workflow-context-budget-v1-trial-assessment-2026-07-22.md](reviews/large-workflow-context-budget-v1-trial-assessment-2026-07-22.md) | Historical V1 evidence only; its estimated threshold and skill-budget conclusions are not current dispatch guidance |
...
| [design/10-wp6-2-t3-t4-live-issue-binding-addendum-2026-07-23.md](design/10-wp6-2-t3-t4-live-issue-binding-addendum-2026-07-23.md) | Proposed shared live-issue claim/evidence/outcome contract pending fresh independent review and exact-identity acceptance; no runtime or provider-call authority |
...
| [handoffs/08-wp6-context-budgeted-manager-handoff-prompt.md](handoffs/08-wp6-context-budgeted-manager-handoff-prompt.md) | Standalone WP6 coordination entry prompt with exact-state reconstruction, no agent-operated CodeRabbit, and context-budget rotation |
| [handoffs/09-wp6-1-closure-and-wp6-2-context-budget-trial.md](handoffs/09-wp6-1-closure-and-wp6-2-context-budget-trial.md) | Executed V1 runbook, retained as trial provenance and superseded for continuation |
| [handoffs/trials/gate6-wp6-2-context-budget-v1-exact-state-handback.md](handoffs/trials/gate6-wp6-2-context-budget-v1-exact-state-handback.md) | Exact V1 certification/intake handback preserved byte-for-byte from the detached trial worktree |
...
| [handoffs/12-wp6-2-runtime-t2-implementation-brief.md](handoffs/12-wp6-2-runtime-t2-implementation-brief.md) | Proposed bounded runtime-T2 dispatch brief for the accepted authority/cost transition family; no credential resolution, provider call, or downstream authority |
| [handoffs/13-wp6-2-t3-t4-live-issue-binding-contract-brief.md](handoffs/13-wp6-2-t3-t4-live-issue-binding-contract-brief.md) | Contract-only brief for the shared canonical claim, live-issue binding, provider evidence, crash semantics, and receipt reconciliation required before T3/T4 resume |
