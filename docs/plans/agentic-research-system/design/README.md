...
| [09-wp6-2-t2-cost-grant-authority-addendum-2026-07-22.md](09-wp6-2-t2-cost-grant-authority-addendum-2026-07-22.md) | `accepted_exact_bytes_only` | P-040 accepts the exact contract/addendum bytes after zero-finding R3 review; no runtime implementation authority |
| [10-wp6-2-t3-t4-live-issue-binding-addendum-2026-07-23.md](10-wp6-2-t3-t4-live-issue-binding-addendum-2026-07-23.md) | `proposed_pending_fresh_independent_review` | Shared T3/T4 claim, live binding, resolver proof, invocation evidence, crash, outcome, and reconciliation contract; no provider call or runtime authority |
