...
8. [WP6.1 schema identity, producer completeness, and historical-event protocol](06h-wp6-1-schema-identity-and-artefact-command-seam-plan.md) — **G-RM-8 `GRANDFATHER` selected and constructed under KAN-95; final post-PR #229 binding census, exact-subject review, and owner acceptance remain open**. The [PR #222 reconciliation evidence](06h-current-producer-and-evidence-record-9736c90-2026-08-09.md) binds the 112-row runtime catalogue and complete append-site census without fabricating the non-reconstructible pre-change baseline. The [attributed decision](06h-g-rm-8-grandfather-decision-3c75d3d-2026-08-09.json) binds the exact 79-event Control prefix and zero missing-triple set.
