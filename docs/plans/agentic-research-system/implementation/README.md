...
8. [WP6.1 schema identity, producer completeness, and historical-event protocol](06h-wp6-1-schema-identity-and-artefact-command-seam-plan.md) — **live-main candidate under KAN-95; owner-blocked on G-RM-8 and exact-subject acceptance**. The [PR #222 reconciliation evidence](06h-current-producer-and-evidence-record-9736c90-2026-08-09.md) binds the current 112-row runtime catalogue and complete append-site census without fabricating the non-reconstructible pre-change baseline. No historical protocol is activated until Stephen makes the separate exact-evidence decision.
