...
**Independent statement reviewer:** Stephen, or a fresh Fable/Opus session (scout plan §8 item 5) — NOT this session's continuation. **Reviewer independence grade is an owner decision (F7):** if the published P01-A bracket is R3-class under W5, a fresh session alone is insufficient and Stephen's sign-off is required regardless.
