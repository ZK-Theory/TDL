...
Two sequential steps after Task completion: write the Task Log, then deliver the Task Report via the bus. Execute after Task completion per `.claude/apm-guides/task-execution.md` §3.6 Task Completion.
...
1. From the completion assessment already presented in chat per `.claude/apm-guides/task-execution.md` §3.6 Task Completion, determine what to capture in the Task Log.
