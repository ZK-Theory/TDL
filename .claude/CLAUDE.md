...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-07-20 (commit fcaa522). Confidence: 100%.
...
### Architecture
repo is a Topological Data Analysis (TDA) research engine that ingests raw financial, poverty, and trajectory datasets, processes them through geometric filtration and homology pipelines, and outputs high-dimensional topological feature vectors for predictive modeling. The system leverages custom graph neural networks (GNNs) and Morse-Smale complex analysis to transform unstructured temporal data into structured topological signatures for downstream research evaluation. The codebase exhibits high research velocity, with 108 files identified as high-churn and high-complexity. New contributors should focus on the research_system/ directory to understand the execution flow, as this is the most active area of development.
...
- `research_system` — The research_system module serves as the core orchestration and execution engine for repowise's Agentic Research System — it consumes…
...
- `trajectory_tda/scripts` — The trajectory_tda/scripts module serves as the execution layer of the trajectory_tda system — it acts as the primary orchestration…
...
### Code health
Three co-equal signals: defect risk 9.41/10 avg, hotspot health 5.2/10 (stable), worst `poverty_tda/validation/spatial_comparison.py` at 1.0/10 · maintainability 9.54/10 · performance risk 258 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
