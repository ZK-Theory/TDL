...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-05 (commit 5df0c00). Confidence: 100%.
...
### Architecture
repo is a topological data analysis (TDA) research engine that ingests raw financial, poverty, and trajectory datasets, processes them through multi-dimensional persistence and Morse-Smale filtration pipelines, and outputs structured topological embeddings and analytical reports. The system leverages graph neural networks and persistent homology to extract latent structural features from complex time-series data, providing a unified framework for cross-domain research validation.
...
- `research_system` — The research_system module serves as the core Topological Analysis Engine, acting as the primary orchestration layer for repowise's…
...
- `trajectory_tda/scripts/stage1/_battery_core.py` — 2 bug fixes, last fix 5 weeks ago; 11 commits/90d
- `research_system/schema_registry.py` — 1 bug fix, last fix 7 days ago; 17 commits/90d
- `research_system/evals/fixture_package.py` — 1 bug fix, last fix 7 days ago; 6 commits/90d
- `tools/sync_agent_skills.py` — 1 bug fix, last fix 2 weeks ago; 9 commits/90d

### Code health
Three co-equal signals: defect risk 9.14/10 avg, hotspot health 5.29/10 (stable), worst `poverty_tda/validation/spatial_comparison.py` at 1.0/10 · maintainability 9.38/10 · performance risk 304 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
