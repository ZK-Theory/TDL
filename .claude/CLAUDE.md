...
## Codebase Intelligence for resolver (Repowise)

Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-07-29 (commit f18e737)
...
### Code health
Three co-equal signals: defect risk 9.4/10 avg, hotspot health 5.29/10 (stable), worst `poverty_tda/topology/multidim_ph.py` at 1.0/10 · maintainability 9.55/10 · performance risk 287 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.

Critical files:
- `shared/manager_dispatch_check.py` — change entropy — impact −3.0
