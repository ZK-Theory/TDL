...
## Codebase Intelligence for petls (Repowise)

Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-07-29 (commit f79fe85)
...
### Code health
Three co-equal signals: defect risk 9.4/10 avg, hotspot health 5.24/10 (stable), worst `poverty_tda/topology/multidim_ph.py` at 1.0/10 · maintainability 9.55/10 · performance risk 287 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
