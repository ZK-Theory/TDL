...
## Codebase Intelligence for rm-plan-docs (Repowise)

Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-07-28 (commit 6137110)
...
- `poverty_tda/topology/multidim_ph.py` — 2 bug fixes, last fix 5 weeks ago; 6 commits/90d

### Code health
Three co-equal signals: defect risk 9.4/10 avg, hotspot health 5.18/10 (stable), worst `poverty_tda/topology/multidim_ph.py` at 1.0/10 · maintainability 9.55/10 · performance risk 282 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
...
- `tests/research_system/unit/test_replay.py` — change entropy — impact −2.1
