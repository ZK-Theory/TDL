...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-05 (commit 6be940d). Confidence: 100%.
...
### Architecture
repo is a Topological Data Analysis (TDA) research engine that consumes raw financial, poverty, and trajectory datasets, processes them through persistent homology and Morse-Smale complex pipelines, and outputs high-dimensional topological feature embeddings for predictive modeling. The system orchestrates complex mathematical transformations across distributed research modules, providing a unified interface for validating topological signatures against canonical research schemas.
...
- `research_system` — The research_system module serves as the core Topological Data Analysis (TDA) layer of repowise, acting as the primary orchestration engine…
...
- `research_system/schema_registry.py` — 1 bug fix, last fix 7 days ago; 16 commits/90d
...
### Code health
Three co-equal signals: defect risk 9.14/10 avg, hotspot health 5.28/10 (stable), worst `poverty_tda/validation/spatial_comparison.py` at 1.0/10 · maintainability 9.38/10 · performance risk 304 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
