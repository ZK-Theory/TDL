...
CASES = {
    "F-021": Case(
        "Governing amendment omitted", "governing_amendment_recall",
        "amendment_omission", "historical", "reconstructed", "R2",
        ("context", "governance"),
        {"operation": "compile_context", "base_revision": "pre-amendment", "governing_amendment": "P-028", "amendment_available": True},
        ...
        ("StaleContextAccepted", "AmendmentSilentlyOmitted"), ("D", "T", "M"), "P1",
    ),
    "F-022": Case(
        "Correlated reviewer contexts", "reviewer_independence_evidence",
        "correlated_review", "specification", "synthetic", "R3",
        ("authority", "scientific_review"),
        {"operation": "grade_independence", "producer_family": "family-a", "reviewer_family": "family-a", "shared_context_hash": True, "role_labels_differ": True},
        {"independence_satisfied": True, "evidence_compared": ["role_labels"]},
        {"independence_satisfied": False, "required_grade": "cross_family_context_independent", "replacement_review_requested": True},
        ("IndependenceEvidenceCompared", "IndependenceUnavailableRecorded"),
        ("RoleLabelTreatedAsIndependence", "CorrelatedReviewAccepted"), ("D", "T", "M", "H"), "P0",
    ),
    "F-025": Case(
        "Orchestrator scope-collapse retrieval", "mandatory_scope_closure",
        "retrieval_scope_collapse", "historical", "reconstructed", "R3",
        ("context", "governance", "claim"),
        {"operation": "retrieve_mandatory_closure", "scope_revision": "stage2-r22", "required_members": 22, "stale_completion_prose": True},
        {"included_members": 8, "completion_recommended": True, "governing_precedence_preserved": False},
        {"included_members": 22, "completion_recommended": False, "governing_precedence_preserved": True, "stale_conflict_labeled": True},
        ("MandatoryClosureResolved", "ScopeRevisionBound", "LowerAuthorityConflictRecorded"),
        ("ScopeCollapsed", "FullStageCompletionRecommended"), ("D", "T", "M", "H"), "P0",
    ),
    "F-026": Case(
        "Implementer scientific-closure retrieval", "implementer_scientific_closure",
        "retrieval_shortcut", "domain_coverage", "synthetic", "R2",
        ("context", "representation", "stochastic", "topology", "provenance"),
        {"operation": "compile_implementer_packet", "required_controls": ["frozen_transform", "null_invariance", "coherent_vintage", "stop_rules"], "distractors": ["refit", "stale_input", "producer_pass"]},
        {"selected_shortcut": "refit", "required_controls_included": 1, "producer_flag_trusted": True},
        {"selected_shortcut": None, "required_controls_included": 4, "producer_flag_trusted": False, "coherent_vintage": True},
        ("ScientificClosureResolved", "FrozenTransformBound", "NullPreflightBound", "VintageBound"),
        ("RefitShortcutIncluded", "ProducerPassTrusted"), ("D", "T", "R", "M", "P"), "P0",
    ),
    "F-027": Case(
        "Optional-index deletion equivalence", "optional_index_deletion_equivalence",
        "optional_index_authority", "specification", "synthetic", "R1",
        ("context", "provenance"),
        {"operation": "compile_with_optional_index", "index_states": ["complete", "deleted"], "direct_sources_available": True},
        ...
        ("MandatorySelectionChanged", "IndexAbsenceLoweredAuthority"), ("D", "T"), "P0",
    ),
    "F-028": Case(
        "Budget overflow fails closed", "context_budget_fail_closed",
        "context_budget_overflow", "specification", "synthetic", "R2",
        ("context", "governance", "operations"),
        {"operation": "compile_over_budget_context", "reference_count": 12000, "reference_ceiling": 10000, "provider_count": 9000, "provider_capacity_80pct": 8000},
        {"packet_issued": True, "mandatory_material_omitted": True},
        {"packet_issued": False, "reason": "context_budget_exceeded", "both_gate_evidence_recorded": True, "safe_options_returned": True},
        ("ReferenceGateMeasured", "ProviderGateMeasured", "ContextCompilationBlocked"),
        ("ContextPacketIssued", "MandatoryMaterialTruncated"), ("D", "T", "O"), "P0",
    ),
    "F-031": Case(
        "Deterministic eligibility-first routing", "deterministic_eligibility_routing",
        "route_nondeterminism", "specification", "synthetic", "R3",
        ("routing", "governance", "operations"),
        {"operation": "route_with_snapshot", "candidate_orders": [["a", "b", "c"], ["c", "a", "b"]], "telemetry_changed_live": True, "suspended_family": "family-c"},
        {"routes_equal": False, "ineligible_route_ranked": True, "coverage_loss_reported": False},
        {"routes_equal": True, "only_eligible_ranked": True, "live_telemetry_ignored": True, "coverage_failure": "r3_family_coverage_insufficient"},
        ("EligibilityEvaluated", "RouteRanked", "FamilyCoverageRecomputed"),
        ("IneligibleRouteSelected", "LiveTelemetryRead", "AffectedDispatchIssued"), ("D", "T", "O", "M"), "P0",
    ),
    "F-033": Case(
        "Producer correlation and verifier feasibility", "predispatch_verifier_feasibility",
        "verifier_unavailable", "specification", "synthetic", "R3",
        ("routing", "authority", "scientific_review", "operations"),
        {"operation": "route_producer_with_verifier_witness", "producer_family": "family-a", "eligible_verifiers": [], "nominal_same_family_verifier": True},
        {"producer_dispatched": True, "independence_checked_after_completion": True},
        {"producer_dispatched": False, "reason": "independence_unavailable", "verifier_witness_bound": True, "role_switch_ignored": True},
        ("VerifierFeasibilityEvaluated", "IndependenceUnavailableRecorded"),
        ("ProducerCommandIssued", "RoleSwitchAcceptedAsIndependent"), ("D", "T", "O", "M", "H"), "P0",
    ),
    "F-035": Case(
        "Requirement-scope integrity and two-key non-compensation", "two_key_assurance_non_compensation",
        "requirement_capture", "specification", "synthetic", "R3",
        ("assurance", "authority", "claim"),
        {"operation": "accept_assurance_requirement", "authored_risk": "R2", "action_risk": "R3", "omitted_lane": "representation", "key_a_passed": True, "key_b_passed": False},
        {"requirement_accepted": True, "manager_only_authority": True, "one_key_compensated": True},
        {"requirement_accepted": False, "reason": "assurance_requirement_scope_unconfirmed", "key_a_passed": True, "key_b_passed": True, "non_compensable": True, "stephen_required": True},
        ("RequirementScopeReviewed", "ActionRiskRaised", "BothValidityKeysEvaluated"),
        ("ProducerDispatchIssued", "OneKeyCompensated", "ClaimPromoted"), ("D", "T", "R", "M", "H"), "P0",
    ),
}
...
def _grader(case_id: str, case: Case, grader_class: str) -> dict[str, Any]:
    ...
    suffixes = {
        "D": "outcome", "T": "trajectory", "R": "research-quality",
        "M": "independent-model", "H": "human-authority",
        "O": "operational", "P": "privacy-security",
    }
...
def _document(case_id: str, name: str, case: Case) -> dict[str, Any]:
    ...
    common = {
        "schema_version": "1.0.0", "fixture_id": case_id,
        "fixture_revision": "r1",
    }
...
def materialize(root: Path, *, check: bool = False) -> None:
    ...
    if check:
        ...
        if observed != set(expected):
            raise SystemExit("context/routing fixture file closure differs from generator")
        mismatches = [
            str(path) for path, data in expected.items() if path.read_bytes() != data
        ]
        if mismatches:
            raise SystemExit(f"context/routing fixtures differ from generator: {mismatches}")
        return
