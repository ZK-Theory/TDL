...
| 1.2b | Blocked — awaiting pre-reg #1 amendment file (T0.13 pipe fix now merged) | tda-agent | run/stage1-headline-batch |
| 1.2c | Blocked — awaiting pre-reg #1 amendment file (LM sensitivity confirmatory scope) | tda-agent | run/stage1-headline-batch |
| 1.2d | Blocked — awaiting pre-reg #1 amendment file | tda-agent | run/stage1-headline-batch |
| 1.2e | Blocked — awaiting T1.2b cache produced | tda-agent | run/stage1-headline-batch |
| 1.2f | Blocked — awaiting pre-reg #5 redo file | tda-agent | run/stage1-headline-batch |
| 1.2g | Blocked — awaiting pre-reg #5 redo file | tda-agent | run/stage1-headline-batch |
...
| tda-agent | 1 | idle — T1.4 Done + merged 2026-05-24 (OVER-DIMENSIONAL, 37.6s walltime); T1.2a Done; T1.2b–h held on pre-reg amendments only (pipe fix merged); worktree run-stage1-headline-batch retained for batch resumption |
