---
name: "source-command-apm-8-summarize-session"
description: "Summarize and optionally archive an APM session."
---

# source-command-apm-8-summarize-session

Use this skill when the user asks to run the migrated source command `apm-8-summarize-session`.
