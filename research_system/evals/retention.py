...
class EvidenceStoreRegistry:
    ...
    verifier_actor_ids: tuple[str, ...]
    verifier_authority_grant_ids: tuple[str, ...]
...
def verify_deletion(
    *,
    ...
    discovered = {
        path.resolve(strict=False) for path in discover_replicas(registry)
    }
    ...
    authority_current = (
        actor_id in registry.verifier_actor_ids
        and authority_grant_id in registry.verifier_authority_grant_ids
    )
    verified = (
