...
def _load_schema_identity_history(root: Path) -> dict[tuple[str, str | None, str], RegisteredSchema]:
    ...
    if (
        ...
        or manifest_raw != canonical_bytes(manifest)
...
_RUNTIME_BINDINGS = (
    ...
    SchemaBinding("ars://core/command", "1.0.0", command_type="SupersedeDiscoveryRecord"),
    ...
    SchemaBinding("ars://core/command", "1.0.0", command_type="RegisterAssayRubricContent"),
    SchemaBinding("ars://core/command", "1.0.0", command_type="RegisterAssayEvidenceScopeContent"),
    SchemaBinding("ars://core/command", "1.0.0", command_type="RecordAssayBarStaleness"),
    SchemaBinding(
        "ars://core/event",
        "1.0.0",
        event_type="CandidateSuperseded",
        producer_command_type="SupersedeDiscoveryRecord",
    ),
    SchemaBinding(
