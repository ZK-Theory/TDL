...
$env:STAGE1_STATUS_FILE = 'C:\Users\steph\TDL\.apm\worktrees\run-headline-batch-frozen-pca-rerun\results\trajectory_tda_integration\stage1\job_logs\job-01-usoc-headline-frozen-2026-05-28.phase-status.log'
$statusPath = 'C:\Users\steph\TDL\.apm\worktrees\run-headline-batch-frozen-pca-rerun\results\trajectory_tda_integration\stage1\job_logs\job-01-usoc-headline-frozen-2026-05-28.status.json'
$logPath = 'C:\Users\steph\TDL\.apm\worktrees\run-headline-batch-frozen-pca-rerun\results\trajectory_tda_integration\stage1\job_logs\job-01-usoc-headline-frozen-2026-05-28.log'
...
$started = Get-Date
[ordered]@{
  job = 'job-01-usoc-headline-frozen-2026-05-28'
  status = 'running'
...
try {
  ...
  [ordered]@{
    ...
    log = $logPath
    phase_status = 'C:\Users\steph\TDL\.apm\worktrees\run-headline-batch-frozen-pca-rerun\results\trajectory_tda_integration\stage1\job_logs\job-01-usoc-headline-frozen-2026-05-28.phase-status.log'
  } | ConvertTo-Json -Depth 6 | Set-Content -LiteralPath $statusPath -Encoding UTF8
} catch {
  $finished = Get-Date
  [ordered]@{
